...
alter table if exists game add constraint FKeup4dd732pnlpjvhh9npcvrg foreign key (current_player_id) references user_profile;
...
alter table if exists game_player add constraint FK64n9da4vaij6uf1pyjknhk053 foreign key (player_id) references user_profile;
